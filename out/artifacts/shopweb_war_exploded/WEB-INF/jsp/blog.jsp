				...
				<div class="blog">
					<div class="blog-grid">
						...
						<div class="blog-grid-header">
							...
							<ul>
								<li><img src="img/cal.png" alt="">February 21,
									2013</li>
								<li><img src="img/admin.png" alt=""><a href="#">Admin</a></li>
								<li><img src="img/post-in.png" alt=""><a href="#">10</a></li>
							</ul>
						</div>
						<div class="image group">
							<div class="grid images_3_of_1">
								<img src="img/grid-img1.jpg">
							</div>
							<div class="grid span_2_of_3">
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing
									...
									cillum dolore eu fugiat nulla pariatur. sed do eiusmod tempor
...
.products-info li a.cart:hover, .products-info li a.i:hover,
	.products-info li a.Compar:hover, .products-info li a.Wishlist:hover {
...
@media screen and (max-width:640px) {
	...
	.products-info ul li:nth-child(2), .products-info ul li:nth-child(3),
		.products-info ul li:nth-child(4) {
		display: none;
	}
	.content-sidebar {
		width: 100%;
