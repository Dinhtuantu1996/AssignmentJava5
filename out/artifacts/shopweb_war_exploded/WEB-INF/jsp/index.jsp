...
<title>JSP Page</title>
	...
	<script type="text/javascript">
		...
		function duyettoi()
		{
			...
			document.getElementById('hopchuaanh').innerHTML = "<a href=''  ><img src='${pageContext.request.contextPath}/img/" + duyet +".png' style='width:100%; height:350px' </a>";
...
<div class="wrap">
                    ...
                    <div class="slideshow-container" >
                        <form>
                            <div id="hopchuaanh">
                                <img src="img/1.png" style="width:100%; height:350px "  id="anh" />
                            </div> 
                            <br />
                        </form>
                    </div>
		    ...
		    <div class="content">
				...
				<div class="grid_1_of_3 images_1_of_3">
					  <a href=""><img src="img/grid-img1.jpg"></a>
					  <h3>Trẻ trung - Hiện đại </h3>
				</div>
				<div class="grid_1_of_3 images_1_of_3 second">
					   <a href=""><img src="img/grid-img2.jpg"></a>
					  <h3>Phong cách - Lịch lãm </h3>
				</div>
				<div class="grid_1_of_3 images_1_of_3 theree">
					   <a href=""><img src="img/grid-img3.jpg"></a>
					  <h3>Mới mẻ - Tiên tiến </h3>
				</div>
			</div>
		    	</div>
		    ...
		    <div class="content-grids">
				...
				<div class="grid_1_of_4 images_1_of_4 products-info">
					 <img src="img/m1.jpg">
					 <a href="">Thông tin điện thoại mới nhất năm 2020</a>
					 <h3>$260</h3>
					 <ul>
...
.products-info li a.cart,.products-info li a.i{
	width: 36px;
	height: 32px;
	background: url("./img/btn-cart.png");
	display:block;
}
...
.products-info li a.Compar{
	background: url("./img/link-compare.png");
	width: 38px;
	height:32px;
	display:block;
}
.products-info li a.Wishlist{
	background: url("./img/link-wishlist.png");
	width: 32px;
	height:32px;
	display:block;
}
...
.content-sidebar li a{
	...
	color: rgb(116, 110, 110);
		display: block;
	padding: 12px 0px;
	background: url("./img/sepHor.png") repeat-x left bottom;
	padding-left:5px;
}
