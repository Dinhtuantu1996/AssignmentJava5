		...
		<form action="login" method="post">
			...
			<ul class="agileinfotickwthree">
				<li><input type="checkbox" id="brand1" value=""> <label
					for="brand1"><span></span>Ghi nhớ</label> <a href="#">Bạn quên
						mật khẩu?</a></li>
			</ul>
			<div class="aitssendbuttonw3ls">
				<input type="submit" value="login">
				<p>
					Tạo tài khoản mới <span>→</span> <a class="w3_play_icon1"
						href=""> Click Here</a>
				</p>
				<div class="clear"></div>
			</div>
...
input[type="text"] {
	background: url("./img/user.png") no-repeat 382px 11px;
	background-size: 25px;
}

input[type="email"] {
	background: url("./img/e-mail.png") no-repeat 382px 11px;
	background-size: 25px;
}

input[type="password"] {
	background: url("./img/password.png") no-repeat 382px 11px;
	background-size: 25px;
}
...
.form-sub-w3ls input[type="text"], .form-sub-w3ls input[type="password"],
	.form-sub-w3ls input[type="email"] {
...
@media screen and (max-width: 480px) {
	...
	input[type="email"] {
		background: url(./img/e-mail.png) no-repeat 300px 11px;
		background-size: 23px;
	}
	input[type="password"] {
		background: url(./img/password.png) no-repeat 300px 11px;
		background-size: 23px;
	}
	ul.agileinfotickwthree a {
		margin-right: 5px;
	...
	input[type="text"] {
		background: url(./img/user.png) no-repeat 300px 11px;
		background-size: 25px;
	}
}
...
@media screen and (max-width: 414px) {
	...
	input[type="email"] {
		background: url("./img/e-mail.png") no-repeat 255px 11px;
		background-size: 23px;
	}
	input[type="password"] {
		background: url("./img/password.png") no-repeat 255px 11px;
		background-size: 23px;
	}
	.aitssendbuttonw3ls p {
		font-size: 13px;
	...
	input[type="text"] {
		background: url("./img/user.png") no-repeat 254px 11px;
		background-size: 25px;
	}
	.contact-w3-agileits h3 {
		font-size: 32px;
...
@media screen and (max-width: 320px) {
	...
	input[type="email"] {
		background: url("./img/e-mail.png") no-repeat 230px 11px;
		background-size: 23px;
	}
	input[type="password"] {
		background: url("./img/password.png") no-repeat 230px 11px;
		background-size: 23px;
	}
	ul.agileinfotickwthree li input[type="checkbox"]+label span:first-child
		{
	...
	input[type="text"] {
		background: url("./img/user.png") no-repeat 229px 11px;
		background-size: 25px;
	}
	.contact-form1 {
		padding: 45px 3px;
